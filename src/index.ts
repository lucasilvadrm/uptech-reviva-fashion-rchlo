...
const listaProdutos: NodeListOf<HTMLElement> = document.querySelectorAll('.product-list__item');
...
function criaLista(
    ...
    if (secao) {
        const ulSecao = criaElemento(elementoFilho, [], '', classePai, secao as HTMLElement);
